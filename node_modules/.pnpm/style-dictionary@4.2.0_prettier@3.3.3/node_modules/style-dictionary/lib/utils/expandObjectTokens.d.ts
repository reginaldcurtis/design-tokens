 ...
 */
export function expandToken(token: DesignToken, opts: Config, platform?: import("../../types/Config.d.ts").PlatformConfig | undefined): import("../../types/DesignToken.d.ts").PreprocessedTokens;
/**
 * @param {PreprocessedTokens} dictionary
 * @param {Config} opts
 * @param {PlatformConfig} [platform]
 */
export function expandTokens(dictionary: PreprocessedTokens, opts: Config, platform?: import("../../types/Config.d.ts").PlatformConfig | undefined): import("../../types/DesignToken.d.ts").PreprocessedTokens;
