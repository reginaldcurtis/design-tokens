 ...
 */
export function preprocess(tokens: PreprocessedTokens, appliedPreprocessors?: string[] | undefined, preprocessorObj?: Record<string, (dictionary: import("../../types/DesignToken.d.ts").PreprocessedTokens, options: import("../../types/Config.d.ts").Config | import("../../types/Config.d.ts").PlatformConfig) => import("../../types/DesignToken.d.ts").PreprocessedTokens | Promise<import("../../types/DesignToken.d.ts").PreprocessedTokens>> | undefined, options?: import("../../types/Config.d.ts").Config | import("../../types/Config.d.ts").PlatformConfig | undefined): Promise<PreprocessedTokens>;
