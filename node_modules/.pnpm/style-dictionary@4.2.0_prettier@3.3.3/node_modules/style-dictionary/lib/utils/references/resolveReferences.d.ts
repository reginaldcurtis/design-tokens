 ...
 */
export function resolveReferences(value: string, tokens: Tokens, opts?: import("../../../types/Config.d.ts").ResolveReferencesOptions | undefined): string | number | undefined;
/**
 ...
 * @returns {string|number|undefined}
 */
export function _resolveReferences(value: string, tokens: Tokens, { regex, separator, opening_character, closing_character, usesDtcg, warnImmediately, ignorePaths, current_context, stack, foundCirc, firstIteration, }?: import("../../../types/Config.d.ts").ResolveReferencesOptionsInternal | undefined): string | number | undefined;
